...
const Utils = {
  ...
  showToast(message, type = 'success', duration = 3000) {
    ...
    const icons = {
      success: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>`,
  ...
  icons: {
    ...
    area: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>',
    bath: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h16a1 1 0 0 1 1 1v3a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4v-3a1 1 0 0 1 1-1z"/><path d="M6 12V4a2 2 0 0 1 2-2h3v2.25"/></svg>',
    ...
    chevronUp: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"/></svg>',
  ...
  // Placeholder image
  placeholderImage(width = 400, height = 300, text = 'Emlak') {
    return `data:image/svg+xml,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}"><rect fill="#1a1a2e" width="${width}" height="${height}"/><rect fill="#262626" x="10" y="10" width="${width - 20}" height="${height - 20}" rx="8"/><text fill="#F59E0B" font-family="sans-serif" font-size="16" font-weight="600" text-anchor="middle" x="${width / 2}" y="${height / 2 - 10}">🏠</text><text fill="#737373" font-family="sans-serif" font-size="12" text-anchor="middle" x="${width / 2}" y="${height / 2 + 15}">${text}</text></svg>`)}`;
  }
};
